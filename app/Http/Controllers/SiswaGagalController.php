...
class SiswaGagalController extends Controller
{
    ...
    //Edit form Gagal
    public function editFormGagal(Request $request){
        $id = $request->input('id');

        $getPendaftarGagal = SiswaGagal::with('sekolah_gagal', 'orang_tua_gagal')->where('id',$id)->first();
        // dd($getPendaftarLolos);

        return view('dashboard.modal_gagal.editGagal', compact('getPendaftarGagal'));
    }

    //Aksi Edit Gagal
    public function editGagal(Request $request, $id){
        ...
        try{
            ...
            $update_data_siswa = SiswaGagal::where('id', $id)->update($data_siswa);
            ...
            $update_data_sekolah = SekolahGagal::where('nik_siswa', $nik)->update($data_sekolah);
            ...
            $update_data_orangtua = OrangTuaGagal::where('nik_siswa', $nik)->update($data_orangtua);
